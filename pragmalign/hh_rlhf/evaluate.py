...
trained_model = "/scr/jphilipp/scai/trained_models/Mistral-7B-v0.1/merged/pragmalign-beta-1.0-iteration-1-0-5k/epoch-0.42/"
trained_dir = "/scr/jphilipp/scai/trained_models/Mistral-7B-v0.1/merged/pragmalign-beta-1.0-iteration-1-0-5k/epoch-0.42/"
...
for TEMPERATURE in TEMPERATURES:
    ...
    for i, (example_helpful, example_harmless) in tqdm(
        ...
        try:    
            ...
            with open(f"{OUTPUT_DIR}/model-t1-temperature-{TEMPERATURE}-beta-1.0-epoch-0.42.json", "w") as file:
