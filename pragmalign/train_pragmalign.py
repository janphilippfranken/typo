...
@hydra.main(version_base=None, config_path="conf", config_name="train_pragmalign")
def main(args: DictConfig) -> None:
    ...
    if local_rank == 0:
        ...
        logging.info(f"beta: {args.pragmalign.beta}")
    ...
    if local_rank == 0:
        ...
        print(len(tokenized_dataset_harmless))
