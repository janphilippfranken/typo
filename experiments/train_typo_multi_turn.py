...
def main(args: DictConfig) -> None:
    ...
    if local_rank == 0:
        ...
        print(dataset_list_helpful_negative[0])
        print(dataset_list_harmless_negative[0])
    ...
    tokenized_dataset_helpful_negative = [tokenize_func(example, tokenizer) for example in dataset_list_helpful_negative]
    tokenized_dataset_harmless_negative = [tokenize_func(example, tokenizer) for example in dataset_list_harmless_negative]

    train_dataset = tokenized_dataset_helpful + tokenized_dataset_harmless + tokenized_dataset_helpful_negative + tokenized_dataset_harmless_negative
