...
def worker_main(rank: int, world_size: int, args: DictConfig, model: nn.Module, tokenizer, mp_policy):
    ...
    model = FSDP(
        model,
        auto_wrap_policy=get_policy(), # currently hardcoded for mixtral
...
def main(args: DictConfig) -> None:
    ...
    mp.spawn(worker_main, nprocs=world_size, args=(world_size, args, model, mp_policy), join=True)
