...
def main(args: DictConfig) -> None:
    ...
    # data 
    with open(f"{args.source_dir_positive}/{args.source_file_positive}.json", "r") as file:
        data = json.load(file)
    ...
    breakpoint()
    mut_inf = [r1 - np.mean([r1, r2]) for r1, r2 in zip(log_probs_positive, log_probs_negative)]
