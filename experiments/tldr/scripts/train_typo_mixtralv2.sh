...
lr=5e-7
iteration=1
checkpoint_dir="/scr/jphilipp/typo/trained_models/Mixtral-8x7b-v.01/checkpoints-sumarization-v2/typo-${lr}-iteration-${iteration}-opus"

python train_typo_mixtralv2.py \
    typo.beta=$beta \
