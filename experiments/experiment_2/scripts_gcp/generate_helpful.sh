...
if [ "$iteration" -gt 0 ]; then
    ...
    model_path="/home/jphilipp/research_projects/typo_files/trained_models/checkpoints-exp-2/beta-${beta}-lr-${lr}-iteration-${iteration}/epoch-1"
    download_dir="/home/jphilipp/research_projects/typo_files/trained_models/checkpoints-exp-2/beta-${beta}-lr-${lr}-iteration-${iteration}/epoch-1"
else
...
# filename for sweep
file_name="${constitution_key}-beta-${beta}-lr-${lr}-iteration-${iteration}"
