...
if [ "$iteration" -gt 0 ]; then
    ...
    model_path="/home/jphilipp/research_projects/typo_files/trained_models/checkpoints-exp-2/beta-${beta}-lr-${lr}-iteration-${iteration}-epoch-0.1/epoch-${epoch}"
    download_dir="/home/jphilipp/research_projects/typo_files/trained_models/checkpoints-exp-2/beta-${beta}-lr-${lr}-iteration-${iteration}-epoch-0.1/epoch-${epoch}"
else
    model_path="mistralai/Mistral-7B-v0.1"
    download_dir="/home/jphilipp/research_projects/typo_files/pretrained_models/Mistral-7B-v0.1"
fi

file_name="${constitution_key}-beta-${beta}-lr-${lr}-iteration-${iteration}-epoch-${epoch}-from-iteration-1-epoch-0.1"
