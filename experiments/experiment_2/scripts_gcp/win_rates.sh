...
echo "SEED"
epoch=0.5
test_file="evaluation-beta-0.0-lr-1e-7-iteration-5-epoch-epoch-${epoch}-temperature-0.0.json"
helpful_win_rates_file_name="5vs0-epoch-${epoch}-helpful_seed_1"
harmless_win_rates_file_name="5vs0-epoch-${epoch}-harmless_seed_1"
