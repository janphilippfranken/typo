...
model_path="/scr/jphilipp/typo/trained_models/Mistral-7B-v0.1/checkpoints-exp-2-v2/dpo-no-sft-0.7/checkpoint-148/"
download_dir="/scr/jphilipp/typo/trained_models/Mistral-7B-v0.1/checkpoints-exp-2-v2/dpo-no-sft-0.7/checkpoint-148/"
...
python evaluate.py \
    ...
    file_name="dpo-no-sft-evaluation-beta-0.7"
