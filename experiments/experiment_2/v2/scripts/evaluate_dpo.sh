...
model_path="/scr/jphilipp/typo/trained_models/Mistral-7B-v0.1/checkpoints-exp-2-v2/sft-dpo-both-0.5/checkpoint-148/"
download_dir="/scr/jphilipp/typo/trained_models/Mistral-7B-v0.1/checkpoints-exp-2-v2/sft-dpo-both-0.5/checkpoint-148/"
...
python evaluate.py \
    ...
    file_name="dpo-sft-both-evaluation-beta-0.5"
