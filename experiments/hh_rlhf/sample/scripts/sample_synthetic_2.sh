...
#SBATCH --output=synthetic_00_mixtral.out         
#SBATCH --error=synthetic_00_mixtral.err           
...
do
    ...
    sampler.dataset_version=synthetic_0 \
    sampler.synthetic_data_path=../label/labels/constitution_0_model_mixtral_7b_base \
