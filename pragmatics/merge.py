...
def main():
    ...
    # load state dict
    state_dict = torch.load('/scr/jphilipp/scai/trained_models/Mistral-7B-v0.1/checkpoints-no-icl/ppo-beta-0.5-helpful-iteration-1-0-10k/epoch-0.32/model.pt', map_location='cpu')
