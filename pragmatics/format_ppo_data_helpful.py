...
PROMPT = """System: Using no more than 300 words, write a response for the assistant that follows the principles in the constitution.
data
### Example 1
...
Assistant: What is a pen and why is it important. I don't understand, sorry.
...
for i, example in tqdm(enumerate(dataset['train']), desc="Processing examples"):
    ...
    sampled_constitutions = sampled_helpful_constitutions 
